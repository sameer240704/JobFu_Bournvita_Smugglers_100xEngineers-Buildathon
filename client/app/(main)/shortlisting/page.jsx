...
const Page = () => {
  ...
  const updateFollowUp = (candidateId, field, value) => {
    setFollowUps((prev) => ({
      ...prev,
      [candidateId]: {
        ...prev[candidateId],
        ...
        {selectedCandidates.map((candidate) => (
          <div key={candidate.id} className="border p-4 rounded-lg">
            <div className="flex justify-between items-start">
              ...
              <button
                onClick={() => addFollowUp(candidate.id)}
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded">
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <select
                      value={followUps[candidate.id].status}
                      onChange={(e) =>
                        updateFollowUp(candidate.id, "status", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <textarea
                      value={followUps[candidate.id].notes}
                      onChange={(e) =>
                        updateFollowUp(candidate.id, "notes", e.target.value)
                      }
                      className="mt-1 block w-full rounded border-gray-300"
                      rows="3"
                    />
